    ...
    <q-header elevated>
      <q-toolbar>
        ...
        <div class="q-gutter-sm row items-center no-wrap">
          ...
          <!-- <q-btn round dense flat color="white" icon="language">
            <q-menu
            >
              <q-list style="min-width: 100px">
                <q-card class="text-center no-shadow no-border" v-for="(item,index) in langOptions" @click="setLang(item)" :key="index">
                  <q-btn :label="item.label" style="max-width: 120px !important;" flat dense
          ...
          <q-btn round flat>
            ...
            >
              <q-list style="min-width: 100px">
                <q-card class="text-center no-shadow no-border">
                  <q-btn @click="logout()" :label="$t('admin.exit')" style="max-width: 120px !important;" flat dense
                         class="text-indigo-8"></q-btn>
                </q-card>
              </q-list>
            </q-menu>
    ...
    >
      <q-list>
        <q-item to="/admin" active-class="q-item-no-link-highlighting">
          ...
          <q-item-section>
            <q-item-label>{{ $t('admin.Index') }}</q-item-label>
          </q-item-section>
        </q-item>

        <q-item to="/admin/Categories" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="category"/>
          </q-item-section>
          <q-item-section>
            <q-item-label>{{ $t('admin.categories') }}</q-item-label>
          </q-item-section>
        </q-item>

        <q-item to="/admin/Properties" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="local_offer"/>
          </q-item-section>
          <q-item-section>
            <q-item-label>{{ $t('admin.properties') }}</q-item-label>
          </q-item-section>
        </q-item>

        <q-item to="/admin/Filters" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="filter_alt"/>
          </q-item-section>
          <q-item-section>
            <q-item-label>{{ $t('admin.filters') }}</q-item-label>
          </q-item-section>
        </q-item>

        <q-item to="/admin/Brands" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="branding_watermark"/>
          </q-item-section>
          <q-item-section>
            <q-item-label>{{ $t('admin.brands') }}</q-item-label>
          </q-item-section>
        </q-item>

        <q-item to="/admin/products" active-class="q-item-no-link-highlighting">
          <q-item-section avatar>
            <q-icon name="local_mall"/>
          </q-item-section>
          <q-item-section>
            <q-item-label>{{ $t('admin.products') }}</q-item-label>
          </q-item-section>
        </q-item>
        <q-expansion-item
          icon="pages"
